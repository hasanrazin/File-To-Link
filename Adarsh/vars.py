...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '139.180.154.242'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '139.180.154.242:8080')) if not ON_HEROKU or getenv('FQDN', '139.180.154.242:8080') else APP_NAME+'.herokuapp.com'
