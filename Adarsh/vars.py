...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '192.101.68.177'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '192.101.68.177:8080')) if not ON_HEROKU or getenv('FQDN', '192.101.68.177:8080') else APP_NAME+'.herokuapp.com'
